function generarMenuPages(){
    const menuPages=`<nav class="navbar navbar-expand-lg bg-light fixed-top"> <!-- Agregamos la clase "fixed-top" para fijar la barra de navegación en la parte superior -->
